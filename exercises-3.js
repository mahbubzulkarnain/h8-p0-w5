...
function highestScore (students) {
    // Code disini
    let output = {}
    if(!!!students || !!!students[0] || !!!students[0].name || !!!students[0].score || !!!students[0].class) return output

    students.forEach(function(student){
        if((!!output[student.class] && student.score > output[student.score]) || (!!!output[student.class])){
